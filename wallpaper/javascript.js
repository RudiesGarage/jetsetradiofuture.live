function graffitiSoulSizeAndPosition()
	{
	var e="graffitiSoulFrame",t=1;
	document.getElementById(e).style.width=.75*parseInt(document.getElementById("remote").style.width)+"px",document.getElementById(e).style.height=Math.round(parseInt(document.getElementById(e).style.width)/t)+"px",document.getElementById(e).style.top=Math.round(stageHeight/2)-Math.round(parseInt(document.getElementById(e).style.height)/2)+"px",document.getElementById(e).style.left=Math.round(stageWidth/2)-Math.round(parseInt(document.getElementById(e).style.width)/2)+"px";
	e="graffitiSoul",t=1;
...
function wallpaperImageSizeAndPositionOLD()
	{
	var e="wallpaperImage",t=1280/720;
