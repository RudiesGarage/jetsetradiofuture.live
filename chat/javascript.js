function chatSizeAndPosition()
	...
	e="sendButton",t=215/105;
	document.getElementById(e).style.transition="top .3s ease-out",document.getElementById(e).style.MozTransition="top .3s ease-out",document.getElementById(e).style.WebkitTransition="top .3s ease-out",document.getElementById(e).style.height=Math.round(.65*parseInt(document.getElementById("information").style.height))+"px",document.getElementById(e).style.width=Math.round(parseInt(document.getElementById(e).style.height)*t)+"px",document.getElementById(e).style.left=parseInt(document.getElementById("chat").style.width)-parseInt(document.getElementById(e).style.width)-Math.round(.49*parseInt(document.getElementById("information").style.height))+"px",document.getElementById(e).style.top=parseInt(document.getElementById("chat").style.height)-parseInt(document.getElementById(e).style.height)-Math.round(.15*parseInt(document.getElementById("information").style.height))+"px";
	e="colorPickerButton",t=1;
	document.getElementById(e).style.height=parseInt(document.getElementById("sendButton").style.height)+"px",document.getElementById(e).style.width=parseInt(document.getElementById("sendButton").style.height)+"px",document.getElementById(e).style.top=parseInt(document.getElementById("sendButton").style.top)+"px",document.getElementById(e).style.left=stageWidth-parseInt(document.getElementById(e).style.width)+"px";
	e="messageTextField",t=0;
	...
	e="closeChatButton",t=1;
	document.getElementById(e).style.width=1.35*parseInt(document.getElementById("radioButton").style.height)+"px",document.getElementById(e).style.height=Math.round(parseInt(document.getElementById(e).style.width)/t)+"px",document.getElementById(e).style.left=parseInt(document.getElementById("chat").style.width)-1.76*parseInt(document.getElementById(e).style.width)+"px",document.getElementById(e).style.top="0px";
	e="chatImagesButton",t=1;
	document.getElementById(e).style.width=1.35*parseInt(document.getElementById("radioButton").style.height)+"px",document.getElementById(e).style.height=Math.round(parseInt(document.getElementById(e).style.width)/t)+"px",document.getElementById(e).style.left=parseInt(document.getElementById("chat").style.width)-2.48*parseInt(document.getElementById(e).style.width)+"px",document.getElementById(e).style.top="0px";
	e="fontSizeButton",t=1;
	document.getElementById(e).style.width=1.35*parseInt(document.getElementById("radioButton").style.height)+"px",document.getElementById(e).style.height=Math.round(parseInt(document.getElementById(e).style.width)/t)+"px",document.getElementById(e).style.left=parseInt(document.getElementById("chat").style.width)-3.16*parseInt(document.getElementById(e).style.width)+"px",document.getElementById(e).style.top="0px";
	e="timestampTextField",t=20;
...
function chatImages_SWITCH()
	...
	if(1==chatImagesStatus)
		...
		for(i=0;
		i<e.length;
		i++)e[i].style.visibility="hidden",e[i].style.height="2%"
	}
		...
		for(i=0;
		i<e.length;
		i++)e[i].style.visibility="visible",e[i].style.height="25%"
	}
	chatSizeAndPosition()
}
...
,chatImagesStatus=!0,chatOpacity_Value=!1,scrollTouch=!1,document.getElementById("sendButton").style.pointerEvents="all",document.onkeydown=function(e)
	...
	return"ON"==chat_switchStatus&&13==t&&"all"==document.getElementById("sendButton").style.pointerEvents&&saveChatXML(),220==t?("ON"==tvFrame_switchStatus?-1==document.getElementById("tvFrame").contentWindow.mediaPosition1?document.getElementById("tvFrame").contentWindow.hidePreviewScreen():document.getElementById("tvFrame").contentWindow.playVideoPlayer():(document.getElementById("nextTrackButton").style.opacity=.3,setTimeout(function()
		{
		document.getElementById("nextTrackButton").style.opacity=1
	}
	,250),skipTrack()),!1):38==t&&"ON"==tvFrame_switchStatus?(-1==document.getElementById("tvFrame").contentWindow.mediaPosition1?document.getElementById("tvFrame").contentWindow.hidePreviewScreen():document.getElementById("tvFrame").contentWindow.gotoNextChannel(),!1):40==t&&"ON"==tvFrame_switchStatus?(-1==document.getElementById("tvFrame").contentWindow.mediaPosition1?document.getElementById("tvFrame").contentWindow.hidePreviewScreen():document.getElementById("tvFrame").contentWindow.gotoPrevChannel(),!1):void 0
};
var myimage=document.getElementById("chatTextField");
function MouseWheelHandler(e)
	{
	var e=window.event||e,t=Math.max(-1,Math.min(1,e.wheelDelta||-e.detail));
	return document.getElementById("chatTextField").scrollTop=document.getElementById("chatTextField").scrollTop+-30*t,0==document.getElementById("chatTextField").scrollTop&&(document.getElementById("chatTextField").scrollTop=1,scrollStartingPo=1),document.getElementById("chatTextField").scrollTop==document.getElementById("chatTextField").scrollHeight-document.getElementById("chatTextField").offsetHeight&&(document.getElementById("chatTextField").scrollTop=document.getElementById("chatTextField").scrollTop-1,scrollStartingPo=document.getElementById("chatTextField").scrollTop-1),!1
}
...
function saveChatXML()
	{
	var e,t,n;
	0==savedUsername&&""!==document.getElementById("messageTextField").value&&document.getElementById("messageTextField").value!==defaultLoginInstructions?(username=document.getElementById("messageTextField").value,"djk"==username&&(username="DJProfessorK"),document.getElementById("messageTextField").style.color="#20e537",document.getElementById("messageTextField").value="You have JOINED the chat!!!",document.getElementById("messageTextField").focus(),document.getElementById("messageTextField").maxLength="255",savedUsername=!0,localStorage.savedUsername=username,console.log("You have JOINED the chat!!!"),setTimeout(function()
		{
		document.getElementById("messageTextField").style.color="#FFFFFF",document.getElementById("messageTextField").value=""
	}
	,1e3)):1==savedUsername&&""!==document.getElementById("messageTextField").value&&(document.getElementById("messageTextField").style.opacity=.3,document.getElementById("sendButton").style.opacity=.1,document.getElementById("sendButton").style.pointerEvents="none",tmpStr=document.getElementById("messageTextField").value,searchThis=tmpStr.substring(0,5),"/join"==searchThis&&(console.log("SAVING USERNAME"),usernameToSave=tmpStr.slice(6),"djk"==usernameToSave&&(usernameToSave="DJProfessorK"),localStorage.savedUsername=usernameToSave,username=usernameToSave,document.getElementById("messageTextField").value="Joined!"),e=document.getElementById("messageTextField").value,t=attachedColorPickerString+e,chatpassword=queryValue("p"),postMessage="chatmessage="+t+"&username="+username+"&chatpassword="+chatpassword,(n=new XMLHttpRequest).open("POST","chat/save.php",!0),n.setRequestHeader("Content-type","application/x-www-form-urlencoded"),n.send(postMessage),console.log("SENDING Chat Message..."),n.onreadystatechange=function()
		{
		4==n.readyState&&(console.log("Chat Message SENT!"),"none"==document.getElementById("sendButton").style.pointerEvents&&(document.getElementById("messageTextField").value="",document.getElementById("messageTextField").focus(),document.getElementById("messageTextField").style.opacity=1,document.getElementById("sendButton").style.opacity=1,document.getElementById("sendButton").style.pointerEvents="all"),clearTimeout(continuousChatLoading),loadChatXML())
	}
...
var chatDefault=savedUsername=!1,xmlDocument="",newXMLDocumentData="",newChatDocumentValue="",oldXMLDocumentData="",oldChatDocumentValue="",lastMessagePosition="",lastMessageValue="",lastTimestampValue=0,messageCounter=0,canConstruct=!0,loadingInsert=":";
	...
	1==navigator.onLine&&(xmlDocument="",chatLoadRequest=new XMLHttpRequest,randomCacheNumber=Math.floor(999999999*Math.random()+1),chatLoadRequest.open("GET","chat/messages.xml?"+randomCacheNumber,!0),chatLoadRequest.send(),console.log("Chat Messages - Loading..."),0==navigator.onLine&&chatLoadRequest.abort(),chatLoadRequest.onreadystatechange=function()
		...
		if(4==chatLoadRequest.readyState&&void 0!==chatLoadRequest.responseXML&&null!==chatLoadRequest.responseXML)
			...
			if(newChatDocumentValue!==oldChatDocumentValue)
				{
				for(oldXMLDocumentData=newXMLDocumentData,oldChatDocumentValue=newChatDocumentValue,composedMessage="",m=constructStartingPoint;
				m<newXMLDocumentData.getElementsByTagName("message").length;
				m++)outputUsername=void 0!==newXMLDocumentData.getElementsByTagName("username")[m].childNodes[0]?newXMLDocumentData.getElementsByTagName("username")[m].childNodes[0].nodeValue:"ERROR",outputMessage=void 0!==newXMLDocumentData.getElementsByTagName("text")[m].childNodes[0]?newXMLDocumentData.getElementsByTagName("text")[m].childNodes[0].nodeValue:"ERROR","ERROR"!==outputUsername&&"ERROR"!==outputMessage&&(
				composedMessage=composedMessage+"<font style='color:#006d90;font-family:regularfont;font-weight:bold;pointer-events:none;'>"+outputUsername+"</font><font style='color:#f2f2f2;'>: "+outputMessage+"</font><br>");
				var t=document.createElement("div");
				for(t.innerHTML=composedMessage;
				t.firstChild;
				)document.getElementById("chatTextField").appendChild(t.firstChild);
				if(0==chatImagesStatus)
					{
					var n=document.getElementsByClassName("imageController");
					for(i=0;
					i<n.length;
					i++)n[i].style.visibility="hidden",n[i].style.height="2%"
				}
