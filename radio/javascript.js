function setupUserDefaults()
	{
	if(selectedStationNum=0,console.log("DEFAULT STATION: "+localStorage.lastStation),void 0!==localStorage.lastStation)for(s=0;
	s<=stationsArray.length;
	s++)stationsArray[s]==localStorage.lastStation&&(selectedStationNum=s);
