...
export default class App extends Component {
        ...
        this.setState((state) => {
            ...
            if (buf.messages.length > 0) {
                ...
                let stored = {
                    ...
                    unread: Unread.NONE,
                    receipts: {
                        [ReceiptType.READ]: receiptFromMessage(lastMsg)
                    },
                };
    ...
    addMessage(serverID, bufName, msg) {
                ...
                notif.addEventListener("click", (event) => {
                    if (event.action === "accept") {
                        let stored = {
                            ...
                            server: client.params,
                            receipts: {
                                [ReceiptType.READ]: receiptFromMessage(msg)
                            },
                        };
                        if (this.bufferStore.put(stored)) {
                            this.sendReadReceipt(client, stored);
        ...
        this.setBufferState(bufID, (buf) => {
            ...
            let receipts = {
                [ReceiptType.DELIVERED]: receiptFromMessage(msg)
            };
    ...
    render() {
        ...
        <div id="activeChatContainer">
            ...
            <div class="activeChatLogContainer">
			${bufferHeader}
			<${ScrollManager}
				target=${this.buffer}
				stickTo=".logline"
