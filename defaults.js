function defineAllRequiredFunctions()
	{
	for(x=0;
	x<allRuntimeFunctionsList.length;
	x++)allRuntimeFunctionsList[x]()
}
function allSizeAndPosition()
	...
	for(var e=0;
	e<allSizeAndPositionFunctionsList.length;
	e++)allSizeAndPositionFunctionsList[e]()
}
...
function shuffleArray(e)
	{
	for(var t=e.length,n=0,s=0;
	0!==t;
	)s=Math.floor(Math.random()*t),n=e[--t],e[t]=e[s],e[s]=n
}
