function remoteSizeAndPosition() {
    ...
    e = "stationsTitle", n = 8;
    document.getElementById(e).style.width = parseInt(document.getElementById("remote").style.width) + "px", document.getElementById(e).style.height = Math.round(parseInt(document.getElementById(e).style.width) / n) + "px", document.getElementById(e).style.top = .04 * parseInt(document.getElementById("remote").style.height) + "px", document.getElementById(e).style.left = "0px";
    ...
    e = "shuffleOff", n = 4;
    document.getElementById(e).style.height = parseInt(document.getElementById("radioButton").style.height) + "px", document.getElementById(e).style.width = Math.round(parseInt(document.getElementById(e).style.height) * n) + "px", document.getElementById(e).style.left = stageWidth / 2 - parseInt(document.getElementById(e).style.width) / 2 + "px", document.getElementById(e).style.top = .12 * parseInt(document.getElementById("radioButton").style.height) + "px";
    e = "shuffleOn", n = 4;
    ...
    for (document.getElementById(e).style.height = parseInt(document.getElementById("remote").style.height) + "px", document.getElementById(e).style.width = parseInt(document.getElementById("remote").style.width) + "px", document.getElementById(e).style.top = .12 * parseInt(document.getElementById("remote").style.height) + "px", t = 0; t < totalThumbnails; t++) {
...
function generateStationsMenu() {
    for (totalThumbnails = stationsArray.length, d = 1; d < totalThumbnails; d++) {
...
function remoteSwitch() {
    null == this.remote_switchStatus ? (document.getElementById("remoteDiv").style.transition = "all 0s ease", document.getElementById("remoteDiv").style.MozTransition = "all 0s ease", document.getElementById("remoteDiv").style.WebkitTransition = "all 0s ease", document.getElementById("remoteDiv").style.opacity = 0, document.getElementById("remoteDiv").style.visibility = "hidden", remote_switchStatus = "OFF", document.getElementById("volumeControl").style.visibility = "hidden") : "OFF" == remote_switchStatus ? (1 == volumeControls && (document.getElementById("volumeControl").style.visibility = "visible"), "OFF" == radio_switchStatus && radioSwitch(), "ON" == tvFrame_switchStatus ? tvFrameSwitch() : "ON" == wallFrame_switchStatus ? wallFrameSwitch() : (0 == flagGraffitiSoul && (document.getElementById("graffitiSoul").style.visibility = "visible"), document.getElementById("graffitiSoulFrame").style.zIndex = 1, document.getElementById("remoteDiv").style.visibility = "visible", document.getElementById("remoteDiv").style.transition = "opacity .5s ease", document.getElementById("remoteDiv").style.MozTransition = "opacity .5s ease", document.getElementById("remoteDiv").style.WebkitTransition = "opacity .5s ease", document.getElementById("remoteDiv").style.opacity = 1, remote_switchStatus = "TRANSITIONING", setTimeout(function() {
        ...
        document.getElementById("remoteDiv").style.visibility = "hidden", remote_switchStatus = "OFF", document.getElementById("volumeControl").style.visibility = "hidden"
    }, 500))
}
