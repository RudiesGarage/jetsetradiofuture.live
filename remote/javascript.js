function remoteSizeAndPosition()
	...
	document.getElementById(e).style.width=.75*parseInt(document.getElementById("remote").style.width)+"px",document.getElementById(e).style.height=Math.round(parseInt(document.getElementById(e).style.width)/n)+"px",document.getElementById(e).style.top=.12*parseInt(document.getElementById("remote").style.height)+"px",document.getElementById(e).style.left=.8*parseInt(document.getElementById("remote").style.width)+"px";
	...
	document.getElementById(e).style.width=.75*parseInt(document.getElementById("remote").style.width)+"px",document.getElementById(e).style.height=Math.round(parseInt(document.getElementById(e).style.width)/n)+"px",document.getElementById(e).style.top=.12*parseInt(document.getElementById("remote").style.height)+"px",document.getElementById(e).style.left=.55*-parseInt(document.getElementById("remote").style.width)+"px";
	e="nextTrackButton",n=190/209;
	document.getElementById(e).style.height=parseInt(document.getElementById("remote").style.width)/6+"px",document.getElementById(e).style.width=parseInt(document.getElementById("remote").style.height)/6+"px",document.getElementById(e).style.left=.48*parseInt(document.getElementById("remote").style.width)+"px",document.getElementById(e).style.top=1.02*parseInt(document.getElementById("remote").style.height)+"px";
	e="pauseTrackButton",n=190/209;
	document.getElementById(e).style.height=parseInt(document.getElementById("remote").style.width)/6+"px",document.getElementById(e).style.width=parseInt(document.getElementById("remote").style.height)/6+"px",document.getElementById(e).style.left=.35*parseInt(document.getElementById("remote").style.width)+"px",document.getElementById(e).style.top=1.02*parseInt(document.getElementById("remote").style.height)+"px";
	...
	document.getElementById(e).style.height=parseInt(document.getElementById("radioButton").style.height)+"px",document.getElementById(e).style.width=parseInt(document.getElementById("radioButton").style.width)+"px",document.getElementById(e).style.left=stageWidth-parseInt(document.getElementById(e).style.width)+"px",document.getElementById(e).style.top=.08*parseInt(document.getElementById(e).style.width)+"px";
...
function guiSwitchSizeAndPosition()
	{
	var t="guiSwitchON",e=1;
	document.getElementById(t).style.width=.65*parseInt(document.getElementById("radioButton").style.width)+"px",document.getElementById(t).style.height=Math.round(parseInt(document.getElementById(t).style.width)/e)+"px",document.getElementById(t).style.top=stageHeight-1.1*parseInt(document.getElementById(t).style.height)+"px",document.getElementById(t).style.left=stageWidth-1.1*parseInt(document.getElementById(t).style.width)+"px";
	t="guiSwitchOFF",e=1;
