...
document.getElementById("wallFrame").style.backgroundColor="#00a3e0",wallFrame_switchStatus="DEFAULT",allRuntimeFunctionsList[allRuntimeFunctionsList.length]=wallFrameRuntime;
