...
function saveRequest() {
    ...
    postMessage = JSON.stringify({ php_imageLink: php_imageLink, php_imageSize: +php_imageSize, php_xPos: php_xPos, php_yPos: php_yPos, php_rotationSetting: php_rotationSetting });
