...
function canCountSizeAndPosition() {
    document.getElementById("canCount").style.height = Math.round(2.8 * parseInt(document.getElementById("loadingCircle").style.width)) + "px", document.getElementById("canCount").style.width = Math.round(parseInt(document.getElementById("canCount").style.height) / (100 / 150)) + "px", document.getElementById("canCount").style.left = "0px", document.getElementById("canCount").style.top = stageHeight - parseInt(document.getElementById("canCount").style.height) - Math.round(.25 * parseInt(document.getElementById("loadingCircle").style.width)) + "px";
