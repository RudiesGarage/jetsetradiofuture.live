...
function popupSizeAndPosition(e)
	...
	t="popupTitle",n=4.8;
	document.getElementById(t).style.height=parseInt(document.getElementById("popupBar").style.height)+"px",document.getElementById(t).style.width=Math.round(parseInt(document.getElementById(t).style.height)*n)+"px",document.getElementById(t).style.top="0px",document.getElementById(t).style.left="0px";
	t="closePopupButton",n=1;
	document.getElementById(t).style.height=parseInt(document.getElementById("popupBar").style.height)+"px",document.getElementById(t).style.width=Math.round(parseInt(document.getElementById(t).style.height)*n)+"px",document.getElementById(t).style.top="0px",document.getElementById(t).style.left=parseInt(document.getElementById("popupBar").style.width)-parseInt(document.getElementById(t).style.width)+"px";
	t="popup",n=1920/580;
	...
	t="popupClickHereButton",n=962/236;
	document.getElementById(t).style.height=1.2*parseInt(document.getElementById("popupBar").style.height)+"px",document.getElementById(t).style.width=Math.round(parseInt(document.getElementById(t).style.height)*n)+"px",document.getElementById(t).style.top=parseInt(document.getElementById("popup").style.height)-parseInt(document.getElementById(t).style.height)+"px",document.getElementById(t).style.left=parseInt(document.getElementById("popup").style.width)-parseInt(document.getElementById(t).style.width)+"px"
}
...
function animatedWallpaperSizeAndPositionOLD()
	{
	var e="animatedWallpaper",t=1280/720;
