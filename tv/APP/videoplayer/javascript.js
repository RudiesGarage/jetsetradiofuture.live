function previewScreenSizeAndPosition() {
    ...
    e = "playButtonBackground", t = .375;
    document.getElementById(e).style.width = parseInt(document.getElementById("playButton").style.width) + "px", document.getElementById(e).style.height = parseInt(document.getElementById("playButton").style.height) + "px", document.getElementById(e).style.left = parseInt(document.getElementById("playButton").style.left) + "px", document.getElementById(e).style.top = parseInt(document.getElementById("playButton").style.top) + "px";
...
function hidePreviewScreen() {
    document.getElementById("previewWallpaper").style.pointerEvents = "none", document.getElementById("playButton").style.visibility = "hidden", document.getElementById("loadingCircle").style.opacity = .3, document.getElementById("previewScreen").style.opacity = 0, setTimeout(function() {
...
function videoPlayerSizeAndPosition() {
    document.getElementById("videoFrame").style.height = stageHeight + "px", document.getElementById("videoFrame").style.width = stageWidth + "px", document.getElementById("videoFrame").style.left = "0px", document.getElementById("videoFrame").style.top = "0px";
    var e = "videoPlayer",
        t = 1280 / 720;
...
function playVideoPlayer(e) {
    ...
    1 == loadPinnedVideo && (lastDuration = 0), 1 == loadPinnedVideo ? (document.getElementById("videoPlayerMP4").src = "videoplayer/pinned/pinned.mp4", loadPinnedVideo = !1) : 1 == loadSpecificVideo ? (document.getElementById("videoPlayerMP4").src = e, loadSpecificVideo = !1) : (1 == selectedChannel && (document.getElementById("videoPlayerMP4").src = "videoplayer/ch1/" + filesListArray1[mediaPosition1] + ".mp4"), 2 == selectedChannel && (document.getElementById("videoPlayerMP4").src = "videoplayer/ch2/" + filesListArray2[mediaPosition2] + ".mp4"), 3 == selectedChannel && (document.getElementById("videoPlayerMP4").src = "videoplayer/ch3/" + filesListArray3[mediaPosition3] + ".mp4"), 4 == selectedChannel && (document.getElementById("videoPlayerMP4").src = "videoplayer/ch4/" + filesListArray4[mediaPosition4] + ".mp4"), 5 == selectedChannel && (document.getElementById("videoPlayerMP4").src = "videoplayer/ch5/" + filesListArray5[mediaPosition5] + ".mp4"), 6 == selectedChannel && (document.getElementById("videoPlayerMP4").src = "videoplayer/ch6/" + filesListArray6[mediaPosition6] + ".mp4"), 7 == selectedChannel && (document.getElementById("videoPlayerMP4").src = "videoplayer/ch7/" + filesListArray7[mediaPosition7] + ".mp4"), 8 == selectedChannel && (document.getElementById("videoPlayerMP4").src = "videoplayer/ch8/" + filesListArray8[mediaPosition8] + ".mp4"), 9 == selectedChannel && (document.getElementById("videoPlayerMP4").src = "videoplayer/ch9/" + filesListArray9[mediaPosition9] + ".mp4")), document.getElementById("loadingCircle").style.opacity = .3, console.log("LOADING VIDEO..."), document.getElementById("videoPlayer").load()
}
...
function remoteSizeAndPosition() {
    ...
    e = "skipVideoButton", t = 190 / 209;
    document.getElementById(e).style.width = parseInt(document.getElementById("remote").style.width) + "px", document.getElementById(e).style.height = Math.round(parseInt(document.getElementById(e).style.width) / t) + "px", document.getElementById(e).style.left = parseInt(document.getElementById("remote").style.left) + "px", document.getElementById(e).style.top = parseInt(document.getElementById("remote").style.top) - 1.01 * parseInt(document.getElementById(e).style.height) + "px";
    e = "zoomButton", t = 1.04;
    document.getElementById(e).style.width = parseInt(document.getElementById("remote").style.width) + "px", document.getElementById(e).style.height = Math.round(parseInt(document.getElementById(e).style.width) / t) + "px", document.getElementById(e).style.left = .22 * parseInt(document.getElementById("remote").style.width) + "px", document.getElementById(e).style.top = stageHeight - parseInt(document.getElementById(e).style.height) - .22 * parseInt(document.getElementById("remote").style.width) + "px";
...
function hideRemote() {
    document.getElementById("remote").style.visibility = "hidden", document.getElementById("skipVideoButton").style.visibility = "hidden", document.getElementById("zoomButton").style.visibility = "hidden"
}

function showRemote() {
    document.getElementById("remote").style.visibility = "visible", document.getElementById("skipVideoButton").style.visibility = "visible", document.getElementById("zoomButton").style.visibility = "visible"
}
...
function defineRemoteButtons() {
    ...
    e = "skipVideoButton";
    "ontouchmove" in document.documentElement ? (document.getElementById(e).ontouchstart = function(e) {
        document.getElementById("skipVideoButton").style.opacity = .55, e.preventDefault()
    }, document.getElementById(e).ontouchend = function(e) {
        document.getElementById("skipVideoButton").style.opacity = 1, playVideoPlayer(), e.preventDefault()
    }) : (document.getElementById(e).onmousedown = function(e) {
        document.getElementById("skipVideoButton").style.opacity = .55, e.preventDefault()
    }, document.getElementById(e).onmouseup = function(e) {
        document.getElementById("skipVideoButton").style.opacity = 1, playVideoPlayer(), e.preventDefault()
...
screenLayout = "fitframe", loadPinnedVideo = !1, document.getElementById("previewWallpaper").style.opacity = 0, document.getElementById("playButtonBackground").style.opacity = 0, document.getElementById("previewScreen").style.transition = "opacity .7s ease-out", document.getElementById("previewScreen").style.MozTransition = "opacity .7s ease-out", document.getElementById("previewScreen").style.WebkitTransition = "opacity .7s ease-out", document.getElementById("videoFrame").style.backgroundColor = "#000000", document.getElementById("videoPlayer").style.backgroundColor = "#000000", document.getElementById("videoFrame").style.opacity = 0, mediaPosition1 = -1, mediaPosition2 = -1, mediaPosition3 = -1, mediaPosition4 = -1, mediaPosition5 = -1, mediaPosition6 = -1, mediaPosition7 = -1, mediaPosition8 = -1, mediaPosition9 = -1, searchForContinue = !0, loadSpecificVideo = !1, skipFirstTime = !0, lastDuration = 0, document.getElementById("videoPlayer").addEventListener("loadedmetadata", function() {
    console.log("Video META Data Loaded"), document.getElementById("loadingCircle").style.opacity = 1
}, !1), document.getElementById("videoPlayer").addEventListener("loadeddata", function() {
...
}, !1), document.getElementById("videoPlayer").addEventListener("canplay", function() {
    console.log("Video CAN PLAY... force in 5 sec"), forcePlayInterval = setTimeout(function() {
        console.log("FORCE PLAY VIDEO!"), beginPlayingVideo()
    }, 5e3)
}), document.getElementById("videoPlayer").addEventListener("canplaythrough", function() {
    console.log("PLAY VIDEO! CAN PLAY THROUGH"), beginPlayingVideo()
}), document.getElementById("videoPlayer").addEventListener("ended", function() {
    playVideoPlayer()
}, !1), document.getElementById("videoPlayer").addEventListener("webkitendfullscreen", function() {
    playVideoPlayer()
}, !1), document.getElementById("channel1Graphic").style.opacity = 0, document.getElementById("channel2Graphic").style.opacity = 0, document.getElementById("channel3Graphic").style.opacity = 0, document.getElementById("channel4Graphic").style.opacity = 0, document.getElementById("channel5Graphic").style.opacity = 0, document.getElementById("channel6Graphic").style.opacity = 0, document.getElementById("channel7Graphic").style.opacity = 0, document.getElementById("channel8Graphic").style.opacity = 0, document.getElementById("channel9Graphic").style.opacity = 0, allRuntimeFunctionsList[allRuntimeFunctionsList.length] = videoplayerRuntime;