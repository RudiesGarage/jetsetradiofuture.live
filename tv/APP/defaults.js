...
function detectMousePositionsAndGestures() {
    "ontouchmove" in document.documentElement ? (window.document.ontouchstart = function(e) {
        ...
        retrieveMousePositions(e), 1 == gestureDrag && (gestureX_End = mouseX, gestureXDistance_Dragged = gestureX_Start - gestureX_End, gestureY_End = mouseY, gestureYDistance_Dragged = gestureY_Start - gestureY_End, 5 < gestureXDistance_Dragged || gestureXDistance_Dragged < -5 || 5 < gestureYDistance_Dragged || gestureYDistance_Dragged < -5 ? allowClick = !1 : allowClick = !0, checkForAllGestures())
...
function gesturesRuntime() {
    setTimeout(function() {
        detectMousePositionsAndGestures()
    }, 500)
}
function queryValue(e) {
    var t = window.location.search.substring(1);
    console.log("Complete Query: " + t);
    var n = t.split("&");
