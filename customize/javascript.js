...
function wallpaperSelectorSizeAndPosition()
	{
	var e="wallpaperSelector";
	document.getElementById(e).style.height=2*parseInt(document.getElementById("colorButton1").style.height)+4*parseInt(document.getElementById("gif1Button").style.height)+"px",document.getElementById(e).style.width=parseInt(document.getElementById("customize").style.width)+"px",document.getElementById(e).style.top=parseInt(document.getElementById("colorButton1").style.top)+"px",document.getElementById(e).style.left="0px",document.getElementById(e).style.backgroundColor="#000000",document.getElementById(e).style.opacity=.85;
	e="wallpaperSelectorTextField";
	document.getElementById(e).style.width=.8*parseInt(document.getElementById("wallpaperSelector").style.width)+"px",document.getElementById(e).style.height=.08*parseInt(document.getElementById("wallpaperSelector").style.width)+"px",document.getElementById(e).style.top=parseInt(document.getElementById("wallpaperSelector").style.height)/2-parseInt(document.getElementById(e).style.height)/2+"px",document.getElementById(e).style.left=parseInt(document.getElementById("wallpaperSelector").style.width)/2-parseInt(document.getElementById(e).style.width)/2+"px",document.getElementById(e).style.fontFamily="regularfont",document.getElementById(e).style.fontSize=.7*parseInt(document.getElementById(e).style.height)+"px",document.getElementById(e).style.textAlign="left",document.getElementById(e).readOnly=!1,document.getElementById(e).wrap="off",document.getElementById(e).style.color="#FFFFFF",document.getElementById(e).style.backgroundColor="#000000";
	e="saveWallpaperSelector";
	document.getElementById(e).style.height=parseInt(document.getElementById("customButton").style.height)+"px",document.getElementById(e).style.width=parseInt(document.getElementById("customButton").style.width)+"px",document.getElementById(e).style.top=parseInt(document.getElementById("customButton").style.top)+"px",document.getElementById(e).style.left=parseInt(document.getElementById("customButton").style.left)+"px";
